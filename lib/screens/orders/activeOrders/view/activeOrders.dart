...
import 'package:customerservice/screens/orders/activeOrders/controller/activeController.dart';
...
class ActiveOrders extends StatelessWidget {
  final _controller = Get.put(ActiveOrderController());

  @override
  Widget build(BuildContext context) {
    _controller.getActiveOrders();
    return Scaffold(
      appBar: AppBar(
